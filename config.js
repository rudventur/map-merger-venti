...
const DEMO = [
  ...
  { id:'d7', lat:48.861, lng:2.394, username:'GhostOfModernArt', signature:'dead but still making art', cemetery: true, artSpace:{ active:true, offer:{ types:['&#129702; Cemetery'], desc:'P\u00e8re Lachaise \u2014 Eternal open-air sculpture park. Residents include Chopin, Wilde & Jim Morrison. Free entry, no exit.', dateFrom:'1804-05-21', dateTo:'9999-12-31', exchange:['\u{1FAA6} RIP'] }, seek:{ types:['&#127912; Paint'], desc:'Seeking someone to touch up my headstone. Getting mossy.', exchange:['\u{1FAA6} RIP'] }}},
  { id:'d8', lat:51.553, lng:-0.150, username:'DeadGoodPrints', signature:'six feet of creativity', cemetery: true, artSpace:{ active:true, offer:{ types:['&#129702; Cemetery'], desc:'Highgate Cemetery \u2014 Victorian gothic vibes. Karl Marx charges no rent. Overgrown in the best way. Come for the art, stay forever.', dateFrom:'1839-01-01', dateTo:'9999-12-31', exchange:['\u{1FAA6} RIP'] }, seek:{ types:['&#127807; Garden'], desc:'Ivy is taking over. Need a gardener. Urgently. The dead can\u2019t prune.', exchange:['\u{1FAA6} RIP'] }}},
  { id:'d9', lat:45.455, lng:12.352, username:'GondolaGhost', signature:'floating between worlds', cemetery: true, artSpace:{ active:true, offer:{ types:['&#129702; Cemetery'], desc:'San Michele Island \u2014 Venice\u2019s cemetery island. Arrive by vaporetto, leave by... well. Beautiful mosaics, zero Wi-Fi, ultimate peace & quiet.', dateFrom:'1469-01-01', dateTo:'9999-12-31', exchange:['\u{1FAA6} RIP'] }, seek:{ types:['&#129683; Wood'], desc:'Coffins getting creaky. Woodworker needed. Must be comfortable with silence.', exchange:['\u{1FAA6} RIP'] }}},
  { id:'d10', lat:41.882, lng:12.465, username:'CatacomBoss', signature:'underground networking since 300AD', cemetery: true, artSpace:{ active:true, offer:{ types:['&#129702; Cemetery'], desc:'Catacombs of Rome \u2014 The original underground art scene. 500km of tunnels. Gallery space is... infinite. Literally no one will bother you.', dateFrom:'0200-01-01', dateTo:'9999-12-31', exchange:['\u{1FAA6} RIP'] }, seek:{ types:['&#128187; Digital'], desc:'Need help setting up a website. Currently relying on word of mouth (very slow when you\u2019re dead).', exchange:['\u{1FAA6} RIP'] }}},
  { id:'d11', lat:50.073, lng:14.421, username:'BoneChapelBarista', signature:'arranging things beautifully', cemetery: true, artSpace:{ active:true, offer:{ types:['&#129702; Cemetery'], desc:'Sedlec Ossuary, Kutn\u00e1 Hora \u2014 40,000 skeletons arranged into chandeliers & coat of arms. This IS the art. Interior design goals.', dateFrom:'1400-01-01', dateTo:'9999-12-31', exchange:['\u{1FAA6} RIP'] }, seek:{ types:['&#128297; Metal'], desc:'The bone chandelier needs a new chain. Metalworker who doesn\u2019t scare easily.', exchange:['\u{1FAA6} RIP'] }}},
];
